...
void AdjustBestDepthOffset(inout half bestDepth, inout half bestX, inout half bestY, float2 uv, half currX, half currY)
{
	...
	half depth = SAMPLE_TEXTURE2D_X(_CameraDepthTexture, my_point_clamp_sampler, uv.xy + _MainTex_TexelSize.xy * half2(currX, currY)).r;
...
{
	return SAMPLE_TEXTURE2D_X_LOD(_MainTex, my_point_clamp_sampler, uv + _MainTex_TexelSize.xy * texelOffset, 0).xyz;
}
